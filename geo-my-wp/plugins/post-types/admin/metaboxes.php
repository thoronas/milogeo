...
$wppl_meta_box = array(
    'id' => 'wppl-meta-box',
    'title' => 'GMW - Please enter the full address or the latitude / longitude of the location.',
...
function wppl_save_data($post_id) {
    ...
    $address = $_POST[$wppl_meta_box['fields'][0]['id']] . ' ' . $_POST[$wppl_meta_box['fields'][2]['id']] . ' ' . $_POST[$wppl_meta_box['fields'][3]['id']] . ' ' .$_POST[$wppl_meta_box['fields'][4]['id']] . ' ' . $_POST[$wppl_meta_box['fields'][5]['id']];
