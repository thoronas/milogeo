<?php function wppl_rf_admin_settings($wppl_options, $wppl_on) { ?>
<div>
	<table class="widefat">
		<thead>
			<th><h3><input type="button" class="wppl-edit-btn wppl-edit" value="<?php _e('+'); ?>"><?php echo _e('Buddypress - Xprofile fields','wppl'); ?></h3></th>
			<th></th>
		</thead>
	</table>
			...
			<tbody>
				<tr>
					...
					<div class="wppl-settings">
						...
						<div class="clear"></div>
							<span class="wppl-help-message">
								...
								and will autofill the address fields (needs supported browser).', 'wppl'); ?>
							</span>
						</p>
					</div>
					</td>
					<td  class="wppl-premium-version-only">
						<p>
							<input name="wppl_fields[xprofile_address][useit]" type="checkbox" size="5" value="1" <?php if ( isset($wppl_options[xprofile_address][useit]) && $wppl_options[xprofile_address][useit] == 1) echo ' checked="checked"'; ?>/>
						</p>
					</td>
				</tr>
				
				<?php if ( isset($wppl_options['xprofile_address']['useit']) && $wppl_options['xprofile_address']['useit'] == 1) { ?>
				...
				<tr>
					...
					<td  class="wppl-premium-version-only">
						<p>
							...
							<?php echo _e('Street:','wppl'); ?>&#32;<input name="wppl_fields[xprofile_address][street]" type="text" size="5" value="<?php echo ($wppl_options[xprofile_address][street]) ? $wppl_options[xprofile_address][street] : " "; ?>" <?php echo( !$wppl_on['friends'] ) ? " disabled" : "";?>/><br />
							<?php echo _e('Apt/Suit:','wppl'); ?>&#32;<input name="wppl_fields[xprofile_address][apt]" type="text" size="5" value="<?php echo ($wppl_options[xprofile_address][apt]) ? $wppl_options[xprofile_address][apt] : " "; ?>" <?php echo( !$wppl_on['friends'] ) ? " disabled" : "";?>/><br />
							<?php echo _e('City:','wppl'); ?>&#32;<input name="wppl_fields[xprofile_address][city]" type="text" size="5" value="<?php echo ($wppl_options[xprofile_address][city]) ? $wppl_options[xprofile_address][city] : " "; ?>" <?php echo( !$wppl_on['friends'] ) ? " disabled" : "";?>/><br />
							<?php echo _e('State:','wppl'); ?>&#32;<input name="wppl_fields[xprofile_address][state]" type="text" size="5" value="<?php echo ($wppl_options[xprofile_address][state]) ? $wppl_options[xprofile_address][state] : " "; ?>" <?php echo( !$wppl_on['friends'] ) ? " disabled" : "";?>/><br />
							<?php echo _e('Zipcode:','wppl'); ?>&#32;<input name="wppl_fields[xprofile_address][zipcode]" type="text" size="5" value="<?php echo ($wppl_options[xprofile_address][zipcode]) ? $wppl_options[xprofile_address][zipcode] : " "; ?>" <?php echo( !$wppl_on['friends'] ) ? " disabled" : "";?>/><br />
							<?php echo _e('Country:','wppl'); ?>&#32;<input name="wppl_fields[xprofile_address][country]" type="text" size="5" value="<?php echo ($wppl_options[xprofile_address][country]) ? $wppl_options[xprofile_address][country] : " "; ?>" <?php echo( !$wppl_on['friends'] ) ? " disabled" : "";?>/><br />
							<br /><span style="font-weight:bold;"><?php echo _e('Or a Single Full Address Field', 'wppl'); ?></span><br />
							<?php echo _e('Full Address:','wppl'); ?>&#32;<input name="wppl_fields[xprofile_address][address]" type="text" size="5" value="<?php echo ($wppl_options[xprofile_address][address]) ? $wppl_options[xprofile_address][address] : " "; ?>" <?php echo( !$wppl_on['friends'] ) ? " disabled" : "";?>/><br />
						</p>
					</td>
				</tr>
				...
				<tr>
					...
					<td  class="wppl-premium-version-only">
						<p>
							<input name="wppl_fields[xprofile_address][autocomplete]" type="checkbox" size="5" value="1" <?php if ( isset( $wppl_options[xprofile_address][autocomplete]) && $wppl_options[xprofile_address][autocomplete] == 1) echo ' checked="checked"'; ?>/>
						</p>
					</td>
				</tr>
				...
				<tr>
					...
					<td  class="wppl-premium-version-only">
						<p>
							<input name="wppl_fields[xprofile_address][autofill]" type="checkbox" size="5" value="1" <?php if ( isset( $wppl_options[xprofile_address][autofill]) && $wppl_options[xprofile_address][autofill] == 1) echo ' checked="checked"'; ?>/>
						</p>
					</td>
				</tr>
			<?php } ?>
...
<?php }  add_action('wppl_main_settings_page', 'wppl_rf_admin_settings', 3, 2); ?>
